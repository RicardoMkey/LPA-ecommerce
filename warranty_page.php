...
<p class="text">LPA / Warranty Info</p>
</div>

<div class="textbox">
	<p class="text">What a disaster! Your computer has failed, and you’re too busy to take it to the shop to get it ﬁx. Lucky for you, you’re covered with the LPA Pick-up & Return Service! 
	...
	<ul style="list-style:none;content:bullet;color:white">
		...
		<br><li class="text">Pack the hardware in its original box, bubble wrap it and place it in another box, for full rig PC please put it back with the original box with its styrofoam, 
			do remove your GPU if its too heavy; Then we will send by DHL to pickup the parcel. </li>
		<br><li class="text">Shipping and service charges may be applicable IF hardware tested non faulty and / or caused by hardware not purchased from LPA PC, 
			the final decision lies with the staff members.</li>
		<br><li class="text">Please take note that The FREE PICKUP AND RETURN SERVICES covers all the products purchased from LPA and is still under warranty only.</li>
