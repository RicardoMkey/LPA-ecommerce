...
<head>
  ...
  <title>LPA Tech - Manage Users Panel</title>
  <?php
    include "header.php"; 
          ...
          <form id="create" name="create" action="" method="post">
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <span class="helper-text grey-text" data-error="Min 3, Max 12 characters" data-success="Min 3, Max 12 characters">Min 3, Max 12 characters</span>
            ...
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <input name="pwd" id="pwd" type="password" class="validate white-text" minlength="5" maxlength="20">
                <span class="helper-text grey-text" data-error="Min 8, Max 20 characters" data-success="Min 5, Max 20 characters">Min 5, Max 20 characters</span>
