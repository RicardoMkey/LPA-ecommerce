...
<head>
  ...
  <link rel="icon" type="image/png" style="border-radius: 50%;" href="./static/logo.png">
</head>
...
<div class="nav-wrapper" style="height: 100px">
  <nav style="height: 100px;">
    <div class="nav-wrapper black" style="box-shadow: 0px 0px 2px white;">
      <a href="index.php"><img src = "./static/logo.png" alt="logo" id="logo" class="brand-logo glow-image" height="100"/></a>
