...
<p class="text">LPA / Warranty Form</p>
</div>
...
<div class="textbox">
	<p class="text">What a disaster! Your computer has failed, and you’re too busy to take it to the shop to get it ﬁx. Lucky for you, 
		you’re covered with LPA Pick-up & Return Service! We’ll pick-up your computer or hardware or replace it, and bring it back to you at your convenience, saving you time and money.</p>
	<br><br>
	<form method="post">
	<table class="text">
		<tr>
		...
		<tr>
			<td><textarea class="text" name="address" required="required" placeholder="Example : 43 St Pauls Terrace, Brisbane City QLD 4000"></textarea></td>
		</tr>
		<tr>
			<td>Contact Number</td>
		</tr>
		<tr>
			<td><input class="text" type="tel" name="contact" required="required" placeholder="Example : 0123 456 789"></input></td>
		</tr>
		<tr>
			<td>Product name:</td>
		</tr>
